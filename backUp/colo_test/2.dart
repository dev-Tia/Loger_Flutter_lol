...
class J2main extends StatelessWidget {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: Color.fromRGBO(88 , 205, 212, 1)
        ),
         backgroundColor: Color.fromRGBO(44 , 54, 66, 1),
            ...
            Row(
              ...
              //너 내 동료가 되어라//
                Container(     
                  ...
                  child: RaisedButton(                    
                    elevation: 9,
                    color: Color.fromRGBO(88 , 205, 212, 1),
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
